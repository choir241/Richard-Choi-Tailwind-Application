...
export default function Documentation(){
    return(
        <section id = "documentation" className = "flex flex-col items-start pb-8">
            ...
            <p className = "text-base px-6 pb-6">
          ...
          documentation using the feedback and suggestions I received.
            ...
            <div className = "flex justify-evenly items-center max-[800px]:flex-col">      
                <Image src = {documentation} alt = "" className = "w-1/4 max-[800px]:w-full max-[800px]:px-8"/>
                <Image src = {documentation1} alt = "" className = "w-1/4 max-[800px]:w-full max-[800px]:px-8"/>
                <Image src = {documentation2} alt = "" className = "w-1/4 max-[800px]:w-full max-[800px]:px-8"/>
            </div>

            <Link href = "https://choir.hashnode.dev/low-level-documentation" className = "border-b-2 text-lg pb-1 pt-8 mx-6">Documentation Link</Link>
